...
const WaitingStudentsTable = ({
  ...
  const filterType =
    type === ""
      ...
      : type === "Erasmus"
      ? applications?.filter(
          application => application.outgoingStudent.isErasmus
        )
      : applications.filter(
          application => !application.outgoingStudent.isErasmus
        );
  ...
  const filterDepartments =
    department === ""
      ...
      : filterType.filter(
          application =>
            application.outgoingStudent.department.departmentName === department
        );
                      ...
                      return (
                        <TableRow hover key={id} tabIndex={-1} role="checkbox">
                          ...
                          <TableCell align="center">
                            {outgoingStudent.department.departmentName}
                          </TableCell>
                                ...
                                >
                                  ...
                                  {contractedUniDepartments
                                    ?.filter(
                                      dep =>
                                        dep.departmentName ===
                                        applications[0]?.outgoingStudent
