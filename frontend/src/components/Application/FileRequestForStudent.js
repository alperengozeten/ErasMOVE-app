  ...
  return (
    <Stack spacing={2}>
                            ...
                            <MDBCol sm="9">
                              <FormControl sx={{ m: 1, minWidth: 250 }}>
                                ...
                                >
                                  ...
                                  <MenuItem value={"Acceptance Letter"}>
                                    Acceptance Letter
                                  </MenuItem>
                                  <MenuItem value={"Learning Agreement"}>
                                    Learning Agreement
                                  </MenuItem>
                                </Select>
                              </FormControl>
      ...
      <RequestsTable
        ...
        deleteFileRequestRequest={deleteFileRequestRequest}
        isStaff={false}
      />
    </Stack>
  );
